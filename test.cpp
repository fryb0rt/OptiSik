...
void testSolver1() {
	SS solver(3);
	solver.addConstraint(SS::Constraint{ .coefs{3,2,1},.type = SS::ConstraintType::EQUAL, .value = 10 });
	solver.addConstraint(SS::Constraint{ .coefs{2,5,3},.type = SS::ConstraintType::EQUAL, .value = 15 });
...
void testSolver2() {
	SS solver(2);
	solver.addConstraint(SS::Constraint{ .coefs{5,4},.type = SS::ConstraintType::LEQUAL, .value = 32 });
	solver.addConstraint(SS::Constraint{ .coefs{1,2},.type = SS::ConstraintType::LEQUAL, .value = 10 });
	solver.setVariable(0, -2);
	solver.setVariable(1, -3);
	solver.print();
...
void testSolver3() {
	SS solver(3);
	solver.addConstraint(SS::Constraint{ .coefs{2,1,1},.type = SS::ConstraintType::LEQUAL, .value = 18 });
	solver.addConstraint(SS::Constraint{ .coefs{1,2,2},.type = SS::ConstraintType::LEQUAL, .value = 30 });
	solver.addConstraint(SS::Constraint{ .coefs{2,2,2},.type = SS::ConstraintType::LEQUAL, .value = 24 });
...
void testSolver4() {
	SS solver(3);
	solver.addConstraint(SS::Constraint{ .coefs{3,2,1},.type = SS::ConstraintType::LEQUAL, .value = 10 });
	solver.addConstraint(SS::Constraint{ .coefs{2,5,3},.type = SS::ConstraintType::LEQUAL, .value = 15 });
	solver.setVariable(0, -2);
	solver.setVariable(1, -3);
	solver.setVariable(2, -4);
...
void testSolver5() {
	SS solver(3);
	solver.addConstraint(SS::Constraint{ .coefs{2,5,-1},.type = SS::ConstraintType::LEQUAL, .value = 18 });
	solver.addConstraint(SS::Constraint{ .coefs{1,-1,-2},.type = SS::ConstraintType::LEQUAL, .value = -14 });
	solver.addConstraint(SS::Constraint{ .coefs{3,2,2},.type = SS::ConstraintType::EQUAL, .value = 26 });
	solver.setVariable(0, -6);
...
void testSolver6() {
	SS solver(2);
	solver.addConstraint(SS::Constraint{ .coefs{1,3},.type = SS::ConstraintType::LEQUAL, .value = 200 });
	solver.addConstraint(SS::Constraint{ .coefs{1,1},.type = SS::ConstraintType::EQUAL, .value = 80 });
	solver.addConstraint(SS::Constraint{ .coefs{1,0},.type = SS::ConstraintType::GEQUAL, .value = 10 });
...
void testSolver9() {
	SS solver(2);
	solver.addConstraint(SS::Constraint{ .coefs{1,1},.type = SS::ConstraintType::LEQUAL, .value = 5 });
...
void testSolver10() {
	std::string line = "[.#.###.#] (0,2,6,7) (2,3) (1,2,3,5,7) (0,1,3,4,5,6,7) (0,1,2,3,5,7) (0,2,4,5,7) (1,2,6,7) (0,2,3,5) (3,7) (2,3,4) {35,44,107,74,41,44,31,81}";
	auto s = split(line, ' ');
